...
TestData = CaseData(ConfigHandler.data_path + r'Collect/collect_add_tool.yaml').case_process()
...
class TestCollectAddTool:
    ...
    def test_collect_add_tool(self, caseinfo, case_skip):
        """
        :param :
        :return:
        """
...
if __name__ == '__main__':
    pytest.main(['test_collect_add_tool.py', '-s', '-W', 'ignore:Module already imported:pytest.PytestWarning'])
